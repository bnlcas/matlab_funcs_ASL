...
title({'Plot of K-means Clustering of Handshape ERPs on First Two Dimensions of'; 'Multi-Dimensional Scaling of Thumb Electrodes'})


% figure; plot(data((cluster==1),2),data((cluster==1),3),'r.')
% hold
% plot(data((cluster==2),2),data((cluster==2),3),'b.')
% xlabel('Mean High Gamma At Onset on CH 202')
% ylabel('Mean High Gamma At Onset on CH 217')
% legend('Cluster 1', 'Cluster 2')
% title('Plot of K-means Clustering on Handshape in Thumb Electrodes')
