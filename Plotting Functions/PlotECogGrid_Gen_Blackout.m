function PlotECogGrid_Stats_N(ERPs, Means, Blackout_Ch, varargin)
...
%% Processing for Means
    ...
    %% Clear Bad Channels & Blackedout Channels
    clear_bad_chan = true;
    if clear_bad_chan
...
%         Bad_Channels = [Bad_Channels, Cleared_Chans];
        Blackout = find(Blackout_Ch)';
        Bad_Channels = [Bad_Channels, Blackout];
        for i = 1:num_plots
